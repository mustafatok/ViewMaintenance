...
public class HBaseHelper {
	...
	public void put(String table, String row, String fam, String qual,
		...
		put.add(Bytes.toBytes(fam), Bytes.toBytes(qual),
				Bytes.toBytes(val));
		tbl.put(put);
		tbl.close();
	}
	...
	public String getValue(String table, String row, String colfam, String qual) throws IOException {
		...
		return new String(result.getValue(colfam.getBytes(), qual.getBytes()));
	}
	...
	public HColumnDescriptor[] getColumnFamilies(String table)
			throws IOException {
